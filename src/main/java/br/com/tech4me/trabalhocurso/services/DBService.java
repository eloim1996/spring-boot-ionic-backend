...
import br.com.tech4me.trabalhocurso.domain.PagamentoComCartao;
...
import br.com.tech4me.trabalhocurso.domain.enums.Perfil;
...
import br.com.tech4me.trabalhocurso.repositories.CidadeRepository;
import br.com.tech4me.trabalhocurso.repositories.ClienteRepository;
import br.com.tech4me.trabalhocurso.repositories.EnderecoRepository;
import br.com.tech4me.trabalhocurso.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTesteDatabase() throws ParseException {
		...
		Cidade c4 = new Cidade(null, "Teresópolis", est3);
		...
		Cliente cli1 = new Cliente(null, "Patrick","patrick_15_cunha@hotmail.com", "11111111111", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("26458895", "36452259"));
		
		Cliente cli2 = new Cliente(null, "Leandro","teste@teste.com", "11111111111", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli2.getTelefones().addAll(Arrays.asList("36411759", "12345678"));
		
		Cliente cli3 = new Cliente(null, "Eloim","eloim_barbosa@hotmail.com", "17407499799", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		cli3.addPerfil(Perfil.ADMIN);
		cli3.getTelefones().addAll(Arrays.asList("36411759", "12345678"));
		...
		Endereco e3 = new Endereco(null, "Doutor Bretas", "285", "Parque Ingá", "Alto", "25961175", cli3, c4 );
